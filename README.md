...
Hi, I'm Esther Ndukwe a Data Analyst learning AI automation and building practical, real-world workflows with n8n. This repo documents my automation projects, from personal productivity tools to sellable business solutions.
...
I'm currently working on an AI-powered Lead Qualifier & Response Agent  combining lead scoring with automated, personalized replies. Follow along for updates.


*Each project folder contains its own README with setup instructions, the exported workflow JSON, and key lessons learned while building it.*
